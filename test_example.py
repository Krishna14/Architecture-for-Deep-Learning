...
if __name__ == '__main__':
    ...
    test_engine.add_construct(Memory('ifmem16', 80, 40))
    test_engine.add_construct(Memory('kmem', 80, 40))
    test_engine.add_construct(Memory('ofmem', 80, 40))
    test_engine.add_construct(Memory('ofmem2', 80, 40))

    test_engine.add_construct(ProcessingElement('pe', 200, 20))
    test_engine.add_construct(ProcessingElement('pe2', 200, 20))
    # add connections
    test_engine.add_connection('ifmem', 'pe')
    test_engine.add_connection('ifmem16', 'pe2')
    test_engine.add_connection('kmem', 'pe')
    test_engine.add_connection('pe', 'ofmem')
    test_engine.add_connection('ofmem', 'pe2')
    test_engine.add_connection('pe2', 'ofmem2')
    ...
    test_engine.feed_command('ofmem', 'load16   pe2    0x000 8 8')
    test_engine.feed_command('ifmem16', 'load16     pe2    0x000 4 8')

    #test_engine.feed_command('ifmem', 'load8     pe    0x000 8 4')   ???
    test_engine.feed_command('pe2', 'matmul16   ofmem2 ifmem16 ofmem 4 8 8')
    # run test
